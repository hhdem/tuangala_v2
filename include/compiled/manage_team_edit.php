            ...
            <div class="box-content">
				...
				<form id="-user-form" method="post" action="/manage/team/edit.php?id=<?php echo $team['id']; ?>" enctype="multipart/form-data" class="validator">
					...
					<div class="field">
						...
						<label>订金</label>
						<input type="text" size="10" name="schedule_price" id="team-create-team-price" class="number" value="<?php echo moneyit($team['schedule_price']); ?>" datatype="double" require="true" />
						<label>可预订</label>
						<div style="margin-top:5px;" id="express-zone-div"><input type="radio" name="schedulable" value="Y" <?php echo $team['schedulable']=='Y'?'checked':''; ?> />&nbsp;是&nbsp;<input type="radio" name="schedulable" value='N' <?php echo $team['schedulable']=='N'?'checked':''; ?> />&nbsp;否</div>
					...
					<div class="field">
						<label>开始时间</label>
						<input type="text" size="20"  maxLength="20" name="begin_time" id="team-create-begin-time1" class="date" xd="<?php echo date('Y-m-d', $team['begin_time']); ?>" xt="<?php echo date('H:i:s', $team['begin_time']); ?>" value="<?php echo date('Y-m-d H:i:s', $team['begin_time']); ?>" require="true" onFocus="WdatePicker({startDate:'<?php echo date('Y-m-d H:i:s', $team['begin_time']); ?>',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"/>
						<label>结束时间</label>
						<input type="text" size="20" name="end_time" id="team-create-end-time1" class="date" xd="<?php echo date('Y-m-d', $team['end_time']); ?>" xt="<?php echo date('H:i:s', $team['end_time']); ?>" value="<?php echo date('Y-m-d H:i:s', $team['end_time']); ?>" maxLength="20" onFocus="WdatePicker({startDate:'<?php echo date('Y-m-d', $team['end_time']); ?> 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"/>
						<label><?php echo $INI['system']['couponname']; ?>有效期</label>
						<input type="text" size="20" name="expire_time" id="team-create-expire-time1" class="number" value="<?php echo date('Y-m-d', $team['expire_time']); ?>" maxLength="20" onFocus="WdatePicker({startDate:'<?php echo date('Y-m-d', $team['expire_time']); ?> 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"/>
